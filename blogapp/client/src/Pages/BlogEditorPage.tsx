...
const initialBlog = `{"_id":"new_blog","title":"","description":"","tags":[],"img":"","content":[]}`;
...
function BlogEditor() {
  ...
  React.useEffect(() => {
    ...
    if (blogId === "new_blog") {
      const blogFromStorageString = localStorage.getItem("new_blog") || initialBlog;
  ...
  return (
    <div className="flex z-40 mx-auto w-screen top-0 bg-white">
      <EditorSideBar
        blogId={blogId}
        blog={blog}
        setBlog={setBlog}
      ...
      />
      <EditorPage />
      <div className="lg:hidden mx-auto h-[80vh] flex items-center justify-center">
