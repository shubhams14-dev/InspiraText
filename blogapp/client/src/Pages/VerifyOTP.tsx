...
export default function VerifyOtp(): JSX.Element {
  ...
  const { verificationRequired, loading } = useAppSelector((state) => state.user);
  ...
  return (
    <div className="flex h-screen">
      <div className="w-screen top-0 z-50 bg-white flex flex-col items-center justify-center">
        <div className="w-4/5 md:w-2/5">
          ...
          <img src={img} alt="OTP Verification" className="h-40 aspect-square mx-auto" />
